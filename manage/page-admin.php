...
<body>
    ...
    <div class="modal fade" id="studentaddmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form method="POST" action="admin_add_db.php" enctype="multipart/form-data" name="form" id="add" novalidate>
    ...
    <div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="admin_edit_db.php" method="POST" id="up" enctype="multipart/form-data" novalidate>
                    <div class="modal-body">
    ...
    <div class="container d-flex justify-content-center">
        <div class="col col-lg-12"><br>
            <h2 class="d-flex justify-content-center">Admin</h2>
            <div class="card-body">
            ...
            $rs = $conn->query("SELECT * FROM member WHERE level = 'a' OR 'A' ");
    ...
    <script>
        function del(id) {
            if (confirm("ยืนยันการลบข้อมูล")) {
                window.location = "admin_delete_db.php?id=" + id;
            } else {
                return false;
            }
        }
